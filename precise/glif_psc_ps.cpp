...
nest::RecordablesMap< nest::glif_psc_ps > nest::glif_psc_ps::recordablesMap_;
...
template <>
void
RecordablesMap< nest::glif_psc_ps >::create()
{
  insert_( names::V_m, &nest::glif_psc_ps::get_V_m_ );
  insert_( names::ASCurrents_sum, &nest::glif_psc_ps::get_ASCurrents_sum_ );
  insert_( names::I, &nest::glif_psc_ps::get_I_ );
  insert_( names::I_syn, &nest::glif_psc_ps::get_I_syn_ );
  insert_( names::threshold, &nest::glif_psc_ps::get_threshold_ );
  insert_( names::threshold_spike, &nest::glif_psc_ps::get_threshold_spike_ );
  insert_( names::threshold_voltage, &nest::glif_psc_ps::get_threshold_voltage_ );
}
}
...
nest::glif_psc_ps::Parameters_::Parameters_()
  : G_( 9.43 )               // in nS
  , E_L_( -78.85 )           // in mV
...
nest::glif_psc_ps::State_::State_( const Parameters_& p )
  : U_( 0.0 )                  // in mV
...
void
nest::glif_psc_ps::Parameters_::get( DictionaryDatum& d ) const
{
...
double
nest::glif_psc_ps::Parameters_::set( const DictionaryDatum& d )
{
...
void
nest::glif_psc_ps::State_::get( DictionaryDatum& d, const Parameters_& p ) const
{
...
void
nest::glif_psc_ps::State_::set( const DictionaryDatum& d, const Parameters_& p, double delta_EL )
{
...
nest::glif_psc_ps::Buffers_::Buffers_( glif_psc_ps& n )
  : logger_( n )
{
}

nest::glif_psc_ps::Buffers_::Buffers_( const Buffers_&, glif_psc_ps& n )
  : logger_( n )
{
}
...
nest::glif_psc_ps::glif_psc_ps( const glif_psc_ps& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
nest::glif_psc_ps::init_state_( const Node& proto )
{
  const glif_psc_ps& pr = downcast< glif_psc_ps >( proto );
  S_ = pr.S_;
}
...
nest::port
nest::glif_psc_ps::handles_test_event( SpikeEvent&, rport receptor_type )
{
...
void
nest::glif_psc_ps::handle( SpikeEvent& e )
{
...
void
nest::glif_psc_ps::handle( CurrentEvent& e )
{
  assert( e.get_delay_steps() > 0 );
...
void
nest::glif_psc_ps::handle( DataLoggingRequest& e )
{
